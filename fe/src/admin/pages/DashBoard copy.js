        ...
        t.productList.map((tp) => {
          ...
          return [
            ...
            data.category?.map((c, index) =>
              index + 1 == tp.category ? [(c.quantity += tp.quantity)] : []
            ),
            data.category?.map((c, index) =>
              index + 1 == tp.category
            ...
            data.brand?.map((c, index) =>
              index + 1 == tp.brand ? [(c.quantity += tp.quantity)] : []
            ),
            data.brand?.map((c, index) =>
              index + 1 == tp.brand
                ? [(c.profit += (tp.unitPrice - tp.originalPrice) * tp.quantity)]
    ...
    <div>
      ...
      <div className="mt-5">
        ...
        <div className="row m-5">
          <div className="col-12 col-lg-6">
            ...
            <DemoDualAxes data={dataForYearly} />
          </div>
          <div className="col-12 col-lg-6">
      ...
      <div className="mt-5">
        <div className="row m-5">
          ...
          >
            ...
            <input
              onClick={() => setCategorySpec("profit")}
              value={"category"}
              type="radio"
              className="btn-check"
              name="btnradiocate"
      ...
      <div className="mt-5">
        <div className="row m-5">
          ...
          <div className="col-12 col-lg-6 col-xl-4">
            <DemoPie
              data={getTotalYearlyBrand(yearlySelected)}
              spec={brandSpec}
            ></DemoPie>
          </div>
        </div>
